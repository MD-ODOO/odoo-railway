{
    ...
    "data": ["security/groups.xml","security/ir.model.access.csv",
             "security/parrainage_rules.xml","data/sequence.xml",
             "data/demo_data.xml",
            #  "data/national_demo.xml",
             "views/parrainage_views.xml",
             "views/import_views.xml","views/dashboard_views.xml","views/menus.xml"],
    "assets": {
        "web.assets_backend": [
